...
La Regla dels Tres (Rule of Three)
...
1. Objecte Directe (Còpia per Valor)
...
🛠️ Implementació Segura (en Setters i Constructors)
...
3. Còpia Superficial (Shallow Copy / Punter Simple)
